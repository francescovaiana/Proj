...
source "/space/tools/synopsys/syn-L-2016.03-SP5-2/admin/setup/.synopsys_dc.setup"
...
set blockName "ones_counter_shgen"
...
report_area >> ${dirname}/report_area_${blockName}
report_timing >> ${dirname}/report_timing_${blockName}
report_power >> ${dirname}/report_power_${blockName}
